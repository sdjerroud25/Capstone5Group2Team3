            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (error_1 instanceof Error) {
                        console.error('Error loading tags.json:', error_1.message);
                    }
                    else {
                ...
                case 1:
                    ...
                    mqttClient.on('connect', function () {
                        ...
                        var _loop_1 = function (topic) {
                            mqttClient.subscribe(topic, function (err) {
                                if (err) {
                                    console.error("\u274C Failed to subscribe to topic \"".concat(topic, "\":"), err.message);
                                }
                                else {
                    ...
                    mqttClient.on('message', function (topic, payload) {
                        try {
                            ...
                            console.error("Error parsing JSON from topic \"".concat(topic, "\":"), err);
                        }
                    });
